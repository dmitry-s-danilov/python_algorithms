...
gathers profiling statistics from the execution
of module *problem_3_6_lib* functions:
...
# import function to be profiled
from problem_3_6_lib import my_func_1 as f
# sets a random range and an array length
r, n = (1, 100), 10
